...
errors = prom.Counter('client_read_errors', 'Client read errors')

response_time = prom.Histogram('webserver_request_duration', 'Response time', ['client_request_e', 'server_response_e'], 
        ...
        try:
            ...
            if data["message"] == "Read first response from server":
                ...
                response_time.labels(
                    client_request_e=data["data"]["response"]["client_request_e"], 
                    server_response_e=data["data"]["response"]["server_response_e"]
